...
def contain(cmd, container_id, image_name, image_dir, container_dir, ipaddr, gateway, veth):
...
def run(command, image_name, image_dir, container_dir):
    ...
    cb_args = (command, container_id, image_name, image_dir, container_dir, ipaddr, gateway, veth)
