...
def setup_cgroup(container_id, cpu_shares, mlimit, mslimit):
...
def contain(cmd, container_id, image_name, image_dir, container_dir,\
            ipaddr, gateway, veth, cpu_shares, mlimit, mslimit):
    ...
    setup_cgroup(container_id, cpu_shares, mlimit, mslimit)
...
def run(command, image_name, image_dir, container_dir, cpu_shares, mlimit, mslimit):
